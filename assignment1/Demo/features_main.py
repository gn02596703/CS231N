...
#X_train_feats = X_train_feats.T
#X_val_feats = X_val_feats.T
#X_test_feats = X_test_feats.T
...
for lr_idx in range(0,len(learning_rates)):
    for reg_idx in range(0,len(regularization_strengths)):
        ...
        svm = LinearSVM()
        loss_hist = svm.train(X_train_feats, y_train, learning_rate=lr_use, reg=reg_use,
